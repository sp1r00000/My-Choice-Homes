module.exports = {
  ...
  facilities: 'Pebble House accommodates two young people and has two large young people’s bedrooms situated on the first floor. The bedrooms are decorated and furnished to a high standard and are personalised to meet each child’s individual needs. There is facility for two staff members to sleep in to maintain the children’s one to one staffing ratio. The home has an open plan living area on the ground floor which includes kitchen, dining area and lounge. These rooms are decorated and furnished in a style chosen by the children to meet the needs of those in the home. The home has a children’s bathroom on the first floor and a separate toilet on the ground floor, there is a staff bathroom is located on the ground floor. There is a My Choice school room situated in a purpose built building at the back of the property. Each home is fitted with an alarm monitoring system to help safeguard the young people, this alarm is situated on all young people’s bedrooms doors and external doors with its purpose being to alert staff through the night if a young person requires support.',
};
